      ...
      <VCol cols="12">
        <VCard :title="$t('Patient')">
          <VCardText class="d-flex flex-wrap py-4 gap-4"> 
            ...
            <div class="app-user-search-filter d-flex align-center flex-wrap gap-1">
              <div style="width: 50%;    margin-left: -35%; ">
                <VForm @submit.prevent>
                  <VTextField
                    ...
                    :rules="rules"
                    label="search"
                    :placeholder="$t('Search in patients')"
                ...
                <td>
                  <div class="d-flex align-center">
                    <div class="d-flex flex-column">
                      <h6 class="text-base">
                        <RouterLink
                          :to="{ name: 'patient-view-id', params: { id: Patient.id } ,action: 'read',subject: 'patient-show'}"

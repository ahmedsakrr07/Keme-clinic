          ...
          <VTable class="text-no-wrap">
            ...
            <tbody>
              ...
              >
                ...
                >
                  <VBtn
                     v-if="$can('read', 'questioneer-edit')"
                  ...
                  >
                    <VIcon
                      size="22"
                      icon="tabler-edit"
                      :to="{ name: 'questioneer-edit-id', params: { id: subClinic.id } ,action: 'read',subject: 'subClinic-edit'}"
                    />
                  </VBtn>
                
                  <VBtn
                    v-if="$can('read', 'questioneer-delete')"
                    icon
                    size="x-small"
                    color="error"
                    variant="text"

...
ClinicListStore.fetchMangers('Manager').then(response => {
...
ClinicListStore.fetchClinic(Number(route.params.id)).then(response => {
  name.value      = response.data.data.name
  email.value     = response.data.data.email
  phone.value     = response.data.data.phone
  manager.value   = response.data.data.manager
  active.value    = response.data.data.active
})

const update = () => {
  axios.post('/clinics/edit/'+route.params.id, {
    name: name.value,
    email: email.value,
    phone: phone.value,

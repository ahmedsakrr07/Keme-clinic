            ...
            <div class="app-user-search-filter d-flex align-center flex-wrap gap-4">
              ...
              <VBtn
               v-if="$can('read', 'doctor-create')"
                ...
                :to="{ name: 'doctor-add',action: 'read',subject: 'doctor-create'}"
              >
                {{$t('Add new Doctor')}}
              </VBtn>
            </div>
                ...
                <td>
                  <div class="d-flex align-center">
                    ...
                    <div class="d-flex flex-column">
                      <h6 class="text-base">
                        <RouterLink
                          :to="{ name: 'doctor-show-id', params: { id: Doctor.id }  ,action: 'read',subject: 'doctor-show'}"
...
<<<<<<< HEAD
                  <VBtn
                    v-if="$can('read', 'doctor-show')"
                    :to="{ name: 'doctor-view-id', params: { id: Doctor.id } ,action: 'read',subject: 'doctor-edit'}"
                    icon
                    size="x-small"
                    color="info"
                    variant="text"

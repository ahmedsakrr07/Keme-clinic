...
<template>
  <VRow >
      ...
      >
        <VCard
          :title="$t('Patient Profile')" style="background-color: rgb(115 103 240);"
        ></VCard>
          ...
          <VCol cols="12">
              ...
              <VRow >
                ...
                <VCol
                  ...
                  md="6"
                >
                <v-subheader style="font-weight: bold;">Rules Of Billing : </v-subheader>{{ billing }}
                </VCol>
                <VCol
                  cols="6"
                  md="6"
      ...
      <VBtn
                ...
                :to="{ name: 'not-add',action: 'read',subject: 'patient-create'}"
              >
                {{$t('Add new patient')}}
              </VBtn><br><br>

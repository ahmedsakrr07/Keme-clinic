        ...
        <tbody>
              ...
              <tr
                  ...
                  >
                    ...
                    <td>{{ Note.treatment_type }}</td>
                    <td>{{ Note.services }}</td>
                    <td>{{ Note.treatment_modality }}</td>
                    <td>{{ Note.treatment_goals }} </td>
                    <td>{{ Note.session_narrative }}</td>
                    <td>{{ Note.treatment_response }}</td>
                    <td>{{ Note.diagnosis }}</td>
                    <td>{{ Note.chief_complaint }}</td>
                    <td>{{ Note.treatment_and_follow_up_plan }}</td>
                    <!-- 👉 Actions -->
                    <td
                  class="text-center"
                  style="width: 5rem;"
                >
                  <VBtn
                    ...
                    :to="{ name: 'patient-edit-id', params: { id: Note.id } ,action: 'read',subject: 'patient-edit'}"
                    icon
                    size="x-small"
                    color="info"
                    variant="text"
                  ...
                  <VBtn
                    v-if="$can('read', 'patient-edit')"
                    :to="{ name: 'patient-view-id', params: { id: Note.id } ,action: 'read',subject: 'patient-edit'}"
                    icon
                    size="x-small"
                    color="info"
                    variant="text"

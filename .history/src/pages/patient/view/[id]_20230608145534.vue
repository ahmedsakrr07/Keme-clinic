    ...
    <VCol cols="12">
        ...
        <VRow >
          ...
          <VCol
            ...
            md="6"
          >
          <v-subheader style="background-color: rgb(103 150 240);">First Name : {{ name }}</v-subheader>
    ...
    <VCol cols="12">
        ...
        <VRow >
          ...
          <VCol
            ...
            md="6"
          >
          <v-subheader>Name : {{ emergency_name }}</v-subheader>
          ...
          <VCol
            ...
            md="6"
          >
          <v-subheader>Relation : {{ emergency_relation }}</v-subheader>
          ...
          <VCol
            ...
            md="6"
          >
          <v-subheader>Email : {{ emergency_email }}</v-subheader>
          ...
          <VCol
            ...
            md="6"
          >
          <v-subheader>Phone Number : {{ emergency_phone_number }}</v-subheader>
          </VCol>
    ...
    <VCol cols="12">
        ...
        <VRow >
          ...
          <VCol
            ...
            md="6"
          >
          <v-subheader>* Rules Of Billing</v-subheader><br><br>
          ...
          <VCol
            ...
            md="6"
          >
          <v-subheader>* Insurance Information</v-subheader><br><br>
        ...
        <VRow >
          ...
          <VCol
            ...
            md="6"
          >
          <v-subheader>Rules Of Blling : {{ billing }}</v-subheader>
          </VCol>
          <VCol
            cols="6"
            md="6"
          >
          <v-subheader>Insurance Number : {{ insurance_number }}</v-subheader>
          </VCol>
        </VRow>

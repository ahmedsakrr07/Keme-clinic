    ...
    <VCol cols="12">
        ...
        <VRow >
          ...
          <VCol
            ...
            md="6"
          >
          <v-subheader style="font-weight: bold;">Rules Of Blling : {{ billing }}</v-subheader>
          </VCol>
          <VCol
            cols="6"
            md="6"
          >
          <v-subheader style="font-weight: bold;">Insurance Number : {{ insurance_number }}</v-subheader>
          </VCol>
        </VRow>

  ...
  <VRow>
   ...
   cols="6"
      ...
      <VBtn
                ...
                :to="{ name: 'note-add-id', params: { id: route.params.id },action: 'read',subject: 'note-create'}"
              >
                {{$t('Add new note')}}
              </VBtn><br><br>
      <VTable class="text-no-wrap">
        ...
        <thead>
              <tr>
                <th scope="col"> # </th>
                <th scope="col">{{ $t('date_of_service') }} </th>
                <th scope="col">{{ $t('treatment_type') }} </th>
                <th scope="col">{{ $t('services') }} </th>
                <th scope="col">{{ $t('treatment_modality') }} </th>
                <th scope="col">{{ $t('treatment_goals') }}</th>
                <th scope="col">{{ $t('session_narrative') }} </th>
                <th scope="col">{{ $t('treatment_response') }} </th>
                <th scope="col">{{ $t('diagnosis') }} </th>
                <th scope="col">{{ $t('chief_complaint') }} </th>
                <th scope="col">{{ $t('treatment_and_follow_up_plan') }} </th>
              </tr>
            </thead>
        <!-- 👉 table body -->
        <tbody>
              ...
              <tr
                    v-for="Note in Patients"
                    :key="Note.id"
                    style="height: 3.75rem;"
                  >
                    <!-- 👉 Patient -->
                    <td>{{ Note.notes.id }}</td>
                    <td>{{ Note.notes.date_of_service }}</td>
                    <td>{{ Note.notes.treatment_type }}</td>
                    <td>{{ Note.notes.services }}</td>
                    <td>{{ Note.notes.treatment_modality }}</td>
                    <td>{{ Note.notes.treatment_goals }} </td>
                    <td>{{ Note.notes.session_narrative }}</td>
                    <td>{{ Note.notes.treatment_response }}</td>
                    <td>{{ Note.notes.diagnosis }}</td>
                    <td>{{ Note.notes.chief_complaint }}</td>
                    <td>{{ Note.notes.treatment_and_follow_up_plan }}</td>
                    <!-- 👉 Actions -->

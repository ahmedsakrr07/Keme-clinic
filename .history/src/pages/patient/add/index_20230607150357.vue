...
const name     = ref()
       const middle_name',
       const last_name',
      const is_send_emails',
      const is_leave_voice',
      const is_leave_text',
       const address1',
       const address2',
       const city',
      ...
      const birth_date',
       ...
       const emergency_email',
       const emergency_phone_number',
      const emergency_is_send_emails',
      const emergency_is_leave_voice',
      const emergency_is_leave_text',
const email    = ref()
const phone    = ref()
const password    = ref()
const role      = ref()

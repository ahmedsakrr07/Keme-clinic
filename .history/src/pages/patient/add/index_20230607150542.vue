...
const Create = () => {
  axios.post('/patient/create', {
    ...
    email: email.value,
    phone: phone.value,
     middle_name',last_name',is_send_emails',is_leave_voice',is_leave_text',address1',address2',city',state',zip_code',birth_date',gender',relationship_status',employment_status',insurance_number',billing',
       emergency_name',emergency_relation',emergency_email',emergency_phone_number',emergency_is_send_emails',emergency_is_leave_voice',emergency_is_leave_text',

        ...
        <VForm  @submit.prevent="Create">
          ...
          <VRow >
            ...
            >
              <VTextField
                v-model="phone"
                :label="$t('Phone')"
                :rules="[validate.integerValidator]"
              />
            </VCol>
            <VCol
              cols="12"
          ...
          <VRow >
            ...
            <VCol
              ...
              md="6"
            >
            <input type="checkbox" id="emergency_checkbox" v-model="is_send_emails" />
            <label for="checkbox2"> Is Send Emails</label><br>
            <input type="checkbox" id="checkbox2" v-model="is_leave_voice" />
            <label for="checkbox2"> Is Leave Voice</label><br>
            <input type="checkbox" id="checkbox2" v-model="is_leave_text" />
            <label for="checkbox2"> Is Leave Text</label>
            </VCol>

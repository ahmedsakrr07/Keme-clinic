            ...
            <tbody>
              ...
              >
                ...
                >
                  ...
                  <VBtn
                    v-if="$can('read', 'patient-edit')"
                    :to="{ name: 'patient-edit-id', params: { id: Patient.id } ,action: 'read',subject: 'patient-view'}"
                    icon
                    size="x-small"
                    color="info"
                    variant="text"
                  >
                    <VIcon
                      size="22"
                      icon="tabler-eye"
                      :to="{ name: 'patient-view-id', params: { id: Patient.id } ,action: 'read',subject: 'patient-view'}"
                    />
                  </VBtn>

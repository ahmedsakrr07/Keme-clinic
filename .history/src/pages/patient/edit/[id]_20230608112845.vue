...
PatientListStore.fetchPatient(Number(route.params.id)).then(response => {
  ...
  middle_name.v response.data.data.middle_name
  last_name .v response.data.data.last_name
  is_send_emails.v response.data.data.is_send_emails
  is_leave_voice.v response.data.data.is_leave_voice
  is_leave_text.v response.data.data.is_leave_text
  address1.v response.data.data.address1
  address2.v response.data.data.address2
  city.v response.data.data.city
  state.v response.data.data.state
  zip_code.v response.data.data.zip_code
  birth_date.v response.data.data.birth_date
  gender.v response.data.data.gender
  relationship_status .v response.data.data.relationship_status
  employment_status.v response.data.data.employment_status
  insurance_number.v response.data.data.insurance_number
  billing.v response.data.data.billing

  emergency_name.v response.data.data.emergency_name
  emergency_relation.v response.data.data.emergency_relation
  emergency_email.v response.data.data.emergency_email
  emergency_phone_number.v response.data.data.emergency_phone_number
  emergency_is_send_emails.v response.data.data.emergency_is_send_emails
  emergency_is_leave_voice.v response.data.data.emergency_is_leave_voice
  emergency_is_leave_text.v response.data.data.emergency_is_leave_text
})

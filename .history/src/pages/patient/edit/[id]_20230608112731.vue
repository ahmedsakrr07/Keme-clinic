...
PatientListStore.fetchPatient(Number(route.params.id)).then(response => {
  ...
  middle_name = middle_name
    ...
    is_leave_voice = is_leave_voice
    is_leave_text = is_leave_text
    address1 = address1
    address2 = address2
    city = city
    state = state
    ...
    emergency_is_send_emails = emergency_is_send_emails
    emergency_is_leave_voice = emergency_is_leave_voice
    emergency_is_leave_text = emergency_is_leave_text
})

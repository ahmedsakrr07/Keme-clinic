...
NoteListStore.fetchNote(Number(route.params.id)).then(response => {
  ...
  doctor_id.value = response.data.data.doctors
        ...
        <VCol cols="12">
          <VRow>
            ...
            >
              ...
              </VSubheader>{{ treatment_and_follow_up_plan }}
            </VCol>

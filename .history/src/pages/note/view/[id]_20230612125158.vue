  ...
  <VRow>
   ...
   cols="6"
      ...
      <VBtn
                ...
                :to="{ name: '"{ name: 'subclinic-edit-id', params: { id: subClinic.id } ,action: 'read',subject: 'subClinic-edit'}"-edit-id', params: { id: subClinic.id } ,action: 'read',subject: 'subClinic-edit'}"
              >
                {{$t('Add new note')}}
              </VBtn><br><br>

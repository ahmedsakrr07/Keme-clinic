...
NoteListStore.fetchNote(Number(route.params.id)).then(response => {
  ...
  patient_id = response.data.data.patient_id
    date_of_service = response.data.data.date_of_service
    treatment_type  = response.data.data.treatment_type
    services = response.data.data.services
    treatment_modality = response.data.data.treatment_modality
    treatment_goals = response.data.data.treatment_goals
    session_narrative = response.data.data.session_narrative
    treatment_response = response.data.data.treatment_response
    diagnosis = response.data.data.diagnosis
    treatment_and_follow_up_plan = response.data.data.treatment_and_follow_up_plan
    chief_complaint = response.data.data.chief_complaint
})

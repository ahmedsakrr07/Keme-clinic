...
NoteListStore.fetchNote(Number(route.params.id)).then(response => {
  ...
  patient_id = response.data.data. patient_id.value,
    date_of_service = response.data.data. date_of_service.value,
    treatment_type  = response.data.data. treatment_type.value,
    services = response.data.data. services.value,
    treatment_modality = response.data.data. treatment_modality.value,
    treatment_goals = response.data.data. treatment_goals.value,
    session_narrative = response.data.data. session_narrative.value,
    treatment_response = response.data.data. treatment_response.value,
    diagnosis = response.data.data. diagnosis.value,
    treatment_and_follow_up_plan = response.data.data. treatment_and_follow_up_plan.value,
    chief_complaint = response.data.data. chief_complaint.value,
})

...
<script setup>
import { useStaffListStore } from '@/views/apps/staff/useTeamListStore';
...
TeamListStore.fetchTeam(Number(route.params.id)).then(response => {
...
const update = () => {
  axios.post('/team/edit/'+route.params.id, {
    name: name.value,
    email: email.value,
    phone: phone.value,
